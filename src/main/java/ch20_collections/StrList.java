...
public class StrList {
    public static void main(String[] args) {
        ...
        boolean contains1 = strList1.contains(searchElem1); // elem이란 표현을 element의 축약어로 자주 쓰임
        ...
        // "python" 포함 여부는 true / "py" 홤 여부는 false가 출력됩니다.
        ...
        // element의 이룹만 가지고 삭제하는 것이 불가능합니다(이루볼 element 전체 삭제 불가능,
