...
public class Main {
    public static void main(String[] args) {
        System.out.println("안녕하세요, 제 이름은 김민성입니다.");
//        System.out.println(안녕하세요, 제 이름은 김민성입니다.); -> 오류 발생
        ...
        /*
            ...
            하나하나 지정을 해줘야하 한다는 점입니다. 문자와 문자열은 서로 다른 개념인데,
            문자(하나짜리)를 세 번 더했을  경우에 더이상 문자가 아니라 문자열로 인식되기 때문에
            원하는 방식으로 출력되지 않습니다(60번라인)
...
//        int pi2 = 3.14;
        ...
        System.out.println("안녕하세요 제이름은" + name + "입니다. 제 전공은" + major
