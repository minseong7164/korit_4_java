...
//        animal2.fetch(); 오류 발생
        ...
        System.out.println("animal2는 anim1이랑 사실상 같다고 아까 수업해서 Animal 인스턴스 하나 생성");
         ...
         */
//        animal2.fetch(); -> 56번 라인과 비교를 위해 남겨둡니다.
        Dog dog2 = (Dog) animal2;   // 다운캐스팅 방법
        dog2.makeSound();
        dog2.fetch();
        animal2.makeSound();
        ((Dog) animal2).fetch();    // 56번 라인이 있기 때문에 자동완성으로 바로 다운캐스티잉 이루어집니다.
...
//        dog3.makeSound();
        /*
            ...
            Dog() 생성자로 생성됐는지에 따라 우리 프로그램이 오류가 날 수도 있고 안 날수도 있는
